...
module.exports = function(passport) {
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : '157422105003333',
    clientSecret : '35194b1b0384d8dd3a46c493d1110c76',
  ...
  passport.use(new KakaoStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : '0807dea83a1f26746ed0a76568d5a4a6', 
    callbackURL : 'http://localhost:3000/oauth/kakaotalk/callback',
    profileFields : ['email', 'name', 'picture']
